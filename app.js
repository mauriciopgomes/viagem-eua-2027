...
var dayCoords = {
    ...
    5:[37.7749,-122.4194], 6:[37.7749,-122.4194], 7:[37.7749,-122.4194], 8:[37.7749,-122.4194],
    9:[41.7558,-124.2026], 10:[40.8021,-124.1637],
    11:[43.3665,-124.2179], 12:[45.8918,-123.9615],
    13:[47.0,-123.5], 14:[47.9504,-124.3855],
    15:[45.60,-121.18], 16:[42.5558,-114.4701],
    17:[38.5733,-109.5498], 18:[38.5733,-109.5498], 19:[38.5733,-109.5498],
    20:[37.6283,-112.1677], 21:[37.2090,-112.9871], 22:[36.9147,-111.4558],
    23:[36.1699,-115.1398], 24:[36.1699,-115.1398], 25:[36.1699,-115.1398],
    26:[36.5640,-118.7510], 27:[36.5640,-118.7510],
    28:[37.8651,-119.5383],
...
var dayStats = {
    ...
    5: { km: '~600', drive: 'LAX → SF (I-5)', hotel: 'San Francisco' },
    6: { km: '~440', drive: 'Eureka → SF', hotel: 'San Francisco' },
    7: { km: '~30', drive: 'San Francisco', hotel: 'San Francisco' },
    8: { km: '~30', drive: 'San Francisco', hotel: 'San Francisco' },
    9: { km: '~450', drive: 'SF → Redwood NP', hotel: 'Crescent City' },
    10: { km: '~130', drive: 'Redwood NP sul → Eureka', hotel: 'Eureka' },
    11: { km: '~350', drive: 'Eureka → Costa Oregon', hotel: 'Gold Beach' },
    12: { km: '~380', drive: 'Oregon Coast → Cannon Beach', hotel: 'Cannon Beach' },
    13: { km: '~500', drive: 'Cannon Beach → Rainier → Forks', hotel: 'Forks' },
    14: { km: '~100', drive: 'Olympic NP', hotel: 'Forks' },
    15: { km: '~470', drive: 'Forks → Multnomah → The Dalles', hotel: 'The Dalles' },
    16: { km: '~500', drive: 'The Dalles → Twin Falls', hotel: 'Twin Falls' },
    17: { km: '~770', drive: 'Twin Falls → Moab', hotel: 'Moab' },
    18: { km: '~80', drive: 'Canyonlands', hotel: 'Moab' },
    19: { km: '~50', drive: 'Arches NP', hotel: 'Moab' },
    20: { km: '~490', drive: 'Moab → Capitol Reef → Bryce', hotel: 'Bryce Canyon' },
    21: { km: '~130', drive: 'Bryce → Zion', hotel: 'Springdale' },
    22: { km: '~190', drive: 'Zion NP + drive Page', hotel: 'Page' },
    23: { km: '~660', drive: 'Page → Grand Canyon → Vegas', hotel: 'Las Vegas' },
    24: { km: '~210', drive: 'Mt. Charleston + Valley of Fire', hotel: 'Las Vegas' },
    25: { km: '~30', drive: 'Vegas dia livre', hotel: 'Las Vegas' },
    26: { km: '~500', drive: 'Vegas → Three Rivers', hotel: 'Three Rivers' },
    27: { km: '~250', drive: 'Sequoia + Kings Canyon', hotel: 'Three Rivers' },
    28: { km: '~200', drive: 'Yosemite NP dia cheio', hotel: 'Mariposa' },
    29: { km: '~350', drive: 'Yosemite → Monterey', hotel: 'Carmel' },
    30: { km: '~450', drive: 'Carmel → PCH → LA', hotel: 'Los Angeles' },
