...
var routeCoords = [
    // Day 5: LAX → Mariposa (I-5 N → CA-99 N → CA-140 E)
    [33.94,-118.41],  // 0: LAX
    [34.30,-118.47],  // 1: I-5 through San Fernando
    [34.84,-118.87],  // 2: Lebec/Tejon Pass SC
    [35.38,-119.02],  // 3: I-5/CA-99 Bakersfield
    [36.32,-119.65],  // 4: CA-99 near Tulare
    [36.74,-119.77],  // 5: Fresno
    [37.30,-120.48],  // 6: Merced SC
    [37.49,-119.97],  // 7: Mariposa
    // Days 6-7: Yosemite → Oakhurst → Visalia → Three Rivers
    [37.87,-119.54],  // 8: Yosemite Valley
    [37.33,-119.65],  // 9: Oakhurst SC (CA-41 S)
    [36.74,-119.77],  // 10: Fresno (rejoin CA-99)
    [36.33,-119.29],  // 11: Visalia SC
    [36.45,-118.91],  // 12: Three Rivers
    // Day 9: Three Rivers → Vegas (CA-99 S → CA-58 E → I-15 NE)
    [35.38,-119.02],  // 13: Bakersfield SC
    [35.13,-118.44],  // 14: Tehachapi Pass
    [35.05,-118.17],  // 15: Mojave
    [34.90,-117.02],  // 16: Barstow SC
    [35.27,-116.07],  // 17: Baker (I-15)
    [35.61,-115.39],  // 18: Primm/NV border
    [36.17,-115.14],  // 19: Las Vegas
    // Day 13: Vegas → GC → Zion (US-93 → I-40 → AZ-64 → US-89)
    [35.98,-114.83],  // 20: Boulder City
    [35.20,-114.05],  // 21: Kingman SC
    [35.25,-112.19],  // 22: Williams (I-40 E)
    [36.06,-112.14],  // 23: Grand Canyon
    [36.81,-111.63],  // 24: Marble Canyon (US-89A)
    [36.86,-112.53],  // 25: Kanab (US-89)
    [37.02,-112.53],  // 26: Zion/Springdale
    // Day 15: Zion → Bryce (UT-9 → US-89 → UT-12)
    [37.29,-112.68],  // 27: UT-9/US-89 junction
    [37.68,-112.15],  // 28: US-89 N (Panguitch area)
    [37.63,-112.17],  // 29: UT-12 junction
    [37.21,-112.99],  // 30: Bryce Canyon
    // Day 16: Bryce → Moab (US-89 → UT-24 → I-70 → US-191)
    [37.76,-112.33],  // 31: US-89 N
    [38.29,-111.57],  // 32: Capitol Reef/UT-24 area
    [38.75,-111.50],  // 33: I-70 junction
    [38.99,-110.16],  // 34: Green River SC
    [38.57,-109.55],  // 35: Moab
    // Day 19: Moab → SLC → Twin Falls
    [38.99,-110.16],  // 36: Green River (backtrack I-70)
    [39.60,-110.81],  // 37: Price SC (US-6 W)
    [39.97,-111.53],  // 38: Spanish Fork (US-6/I-15)
    [40.76,-111.89],  // 39: SLC
    [41.07,-112.25],  // 40: Antelope Island
    [40.76,-111.89],  // 41: SLC (back)
    [41.73,-112.17],  // 42: Brigham City (I-15 N)
    [42.00,-112.45],  // 43: I-84 W junction
    [42.56,-114.46],  // 44: Twin Falls
    // Day 20: Twin Falls → Centralia (I-84 W → I-82 → I-5 N)
    [42.87,-115.54],  // 45: I-84 W
    [43.62,-116.20],  // 46: Boise SC
    [44.05,-116.97],  // 47: Ontario, OR area
    [44.77,-117.83],  // 48: Baker City SC
    [45.67,-118.79],  // 49: Pendleton SC
    [45.60,-121.18],  // 50: The Dalles SC
    [45.57,-122.40],  // 51: Troutdale/Portland area
    [46.07,-122.88],  // 52: Kelso (I-5 N)
    [46.72,-122.95],  // 53: Centralia
    // Day 21: Centralia → Rainier → Forks
    [46.85,-121.76],  // 54: Mt. Rainier
    [47.04,-122.90],  // 55: Olympia SC
    [47.30,-123.10],  // 56: US-101 N
    [47.59,-123.79],  // 57: US-101 W (Queets area)
    [47.95,-124.39],  // 58: Forks
    // Day 23: Forks → Cannon Beach (US-101 S)
    [47.50,-124.35],  // 59: US-101 S
    [46.98,-123.82],  // 60: Aberdeen SC
    [46.19,-123.83],  // 61: Astoria
    [45.89,-123.96],  // 62: Cannon Beach
    // Day 24: Oregon Coast (US-101 S)
    [45.37,-123.97],  // 63: Lincoln City SC
    [44.96,-124.02],  // 64: Newport
    [43.97,-124.10],  // 65: Florence/Dunes
    [43.37,-124.22],  // 66: Coos Bay SC
    [42.86,-124.42],  // 67: Brookings area
    [42.41,-124.42],  // 68: Gold Beach
    // Day 25: → Crescent City
    [41.94,-124.20],  // 69: Brookings
    [41.76,-124.20],  // 70: Crescent City
    // Day 26: → Eureka (US-101 S)
    [41.20,-124.09],  // 71: Prairie Creek/Orick
    [40.80,-124.16],  // 72: Eureka
    // Day 27: Eureka → SF (US-101 S)
    [40.10,-123.79],  // 73: Garberville
    [39.15,-123.21],  // 74: Ukiah SC
    [38.44,-122.72],  // 75: Santa Rosa
    [38.07,-122.88],  // 76: Point Reyes area
    [37.77,-122.42],  // 77: San Francisco
    // Day 30: SF → PCH south → Santa Barbara
    [37.46,-122.43],  // 78: Half Moon Bay
    [36.97,-122.03],  // 79: Santa Cruz
    [36.60,-121.89],  // 80: Monterey
    [36.37,-121.90],  // 81: Carmel
    [36.27,-121.81],  // 82: Big Sur
    [35.97,-121.47],  // 83: south Big Sur coast
    [35.66,-121.25],  // 84: San Simeon/Elephant Seal
    [35.28,-120.66],  // 85: SLO SC
    [34.95,-120.44],  // 86: Santa Maria
    [34.61,-120.19],  // 87: Gaviota
    [34.42,-119.70],  // 88: Santa Barbara
    // Day 31: Santa Barbara → LA (US-101 → PCH)
    [34.28,-119.29],  // 89: Ventura
    [34.09,-119.04],  // 90: Point Mugu
    [34.03,-118.69],  // 91: Malibu
    [34.02,-118.49],  // 92: Santa Monica
    [34.05,-118.24]   // 93: LA
];

// Day index → route coord index (approximate)
var dayRouteIdx = {
    1:0,2:0,3:0,4:0,5:7,6:8,7:12,8:12,9:19,10:19,11:19,12:19,13:26,14:26,
    15:30,16:35,17:35,18:35,19:44,20:53,21:58,22:58,23:62,24:68,
    25:70,26:72,27:77,28:77,29:77,30:88,31:93,32:93,33:93
};

// Route coordinates per day for day-route highlighting
var dayRouteSegments = {
    5: [[33.94,-118.41],[34.30,-118.47],[34.84,-118.87],[35.38,-119.02],[36.32,-119.65],[36.74,-119.77],[37.30,-120.48],[37.49,-119.97]],
    6: [[37.49,-119.97],[37.87,-119.54]],
    7: [[37.87,-119.54],[37.33,-119.65],[36.74,-119.77],[36.33,-119.29],[36.45,-118.91]],
    9: [[36.45,-118.91],[35.38,-119.02],[35.13,-118.44],[35.05,-118.17],[34.90,-117.02],[35.27,-116.07],[35.61,-115.39],[36.17,-115.14]],
