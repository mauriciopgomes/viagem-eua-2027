...
const days = [
    ...
    },
    {
        ...
        chargeStops: [{ name: 'Barstow, CA', leg: 'LAX → Vegas', critical: false }], location: "New York → LAX → Las Vegas",
        route: "NY → LA → Vegas! ✈️🚗",
    ...
    },
    {
        ...
        chargeStops: [
            { name: 'Kingman, AZ', leg: 'Vegas → GC → Zion', critical: false, note: 'Trecho da Route 66!' },
    ...
    {
        photo: 'img/activities/temple_square.jpg', shortLoc: 'SLC',
        chargeStops: [
            { name: 'Green River, UT', leg: 'Moab → SLC', critical: false },
            { name: 'Price, UT', leg: 'Moab → SLC', critical: false }
    ...
    {
        photo: 'img/activities/shoshone_falls.jpg', shortLoc: 'Boise',
        chargeStops: [{ name: 'Twin Falls, ID', leg: 'SLC → Boise', critical: false }], location: "SLC → Boise",
    ...
    },
    {
        ...
        chargeStops: [
            { name: 'Baker City, OR', leg: 'Boise → Centralia', critical: false },
            { name: 'Pendleton, OR', leg: 'Boise → Centralia', critical: false },
            { name: 'The Dalles, OR', leg: 'Boise → Centralia', critical: false },
            { name: 'Centralia, WA', leg: 'Boise → Centralia', critical: false }
        ], location: "Boise → Multnomah Falls → Centralia",
    ...
    },
    {
        ...
        chargeStops: [{ name: 'Olympia / Centralia, WA', leg: 'Centralia → Rainier → Forks', critical: true, note: '⚠️ CARREGAR ATÉ 100% — Olympic 265 km internos + sem SC até Aberdeen!' }], location: "Centralia → Mt. Rainier → Forks",
    ...
    },
    {
        ...
        chargeStops: [{ name: 'Aberdeen, WA', leg: 'Forks → Cannon Beach', critical: false }], location: "Forks → Cannon Beach",
    ...
    {
        photo: 'img/dia-14.jpg', shortLoc: 'Redwood', location: "Redwood NP dia cheio 🌲",
    ...
    {
        photo: 'img/dia-13.jpg', shortLoc: 'Eureka',
        chargeStops: [{ name: 'Eureka, CA', leg: 'Crescent City → Eureka', critical: false }], location: "Crescent City → Eureka",
    ...
    },
    {
        ...
        chargeStops: [{ name: 'Ukiah, CA', leg: 'Eureka → SF', critical: false }], location: "Eureka → San Francisco",
    ...
    {
        photo: 'img/dia-12.jpg', shortLoc: 'SF', titleSuffix: ' ❤️', location: "San Francisco dia cheio",
    ...
    {
        photo: 'img/activities/malibu_pch.jpg', shortLoc: 'PCH',
        chargeStops: [
            { name: 'Monterey / Salinas, CA', leg: 'SF → PCH → Mariposa', critical: false },
            { name: 'Merced, CA', leg: 'SF → PCH → Mariposa', critical: false }
        ], location: "SF → PCH → Mariposa",
    ...
    {
        photo: 'img/dia-08.jpg', shortLoc: 'Yosemite', location: "Mariposa → Yosemite dia cheio 1",
    ...
    {
        photo: 'img/dia-09.jpg', shortLoc: 'Yosemite', location: "Yosemite dia cheio 2",
    ...
    {
        photo: 'img/dia-07.jpg', shortLoc: '3 Rivers',
        chargeStops: [
            { name: 'Oakhurst, CA', leg: 'Yosemite → Three Rivers', critical: false },
            { name: 'Visalia, CA', leg: 'Yosemite → Three Rivers', critical: true, note: '⚠️ CARREGAR ATÉ 100% — Sequoia sem carregadores! ~190 km de subida/descida!' }
        ], location: "Yosemite → Three Rivers",
    ...
    },
    {
        ...
        chargeStops: [{ name: 'Tejon / Lebec, CA', leg: 'Three Rivers → LA', critical: false }], location: "Three Rivers → Los Angeles",
    ...
    {
        photo: 'img/dia-34.jpg', shortLoc: 'LA', location: "LA — Malibu + Venice + Griffith",
...
//
// Exemplo: trocar dia 6 (Vegas) com dia 7 (Valley of Fire):
//   1. Recorte o objeto do dia 6 (de { photo: ... } até o } antes do próximo dia)
//   2. Cole na posição do dia 7
//   3. Pronto! initDays() recalcula tudo.
//
